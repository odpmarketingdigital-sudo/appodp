...
export function Ga4DashboardCharts({ report }: Ga4DashboardChartsProps) {
  const { summary, timeline, cities, channels, ageBrackets } = report;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <ChartCard title="Top cidades" subtitle="Por visitas (activeUsers)">
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={cities} layout="vertical" margin={{ left: 8, right: 16 }}>
                ...
                />
                <Tooltip content={<DarkTooltip />} />
                <Bar dataKey="activeUsers" name="Visitas" fill="#60a5fa" radius={[0, 4, 4, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </ChartCard>
      ...
      <ChartCard title="Demografia" subtitle="Faixa etária (userAgeBracket)">
        <div className="h-72 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={ageBrackets}>
              ...
              <Tooltip content={<DarkTooltip />} />
              <Bar dataKey="activeUsers" name="Visitas" fill="#a78bfa" radius={[4, 4, 0, 0]} />
              <Bar dataKey="eventCount" name="Eventos" fill="#fbbf24" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </ChartCard>
...
function SummaryCard({
  ...
  return (
    <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-5">
      ...
      <div className="mt-3 h-1 rounded-full" style={{ backgroundColor: color, opacity: 0.5 }} />
    </div>
  );
}
